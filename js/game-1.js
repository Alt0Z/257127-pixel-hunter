...
const question1 = gameOne.querySelectorAll(`input[name="question1"]`);
const question2 = gameOne.querySelectorAll(`input[name="question2"]`);
const form = gameOne.querySelector(`form`);
